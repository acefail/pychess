...
class Piece:
    def __init__(self, team, type, image, moved=0, killable=False):
        self.team = team
        self.type = type
...
bp = Piece('b', 'p', './PiecesImg/B_Pawn.png')
wp = Piece('w', 'p', './PiecesImg/W_Pawn.png')
bk = Piece('b', 'k', './PiecesImg/B_King.png')
wk = Piece('w', 'k', './PiecesImg/W_King.png')
br = Piece('b', 'r', './PiecesImg/B_Rook.png')
wr = Piece('w', 'r', './PiecesImg/W_Rook.png')
bb = Piece('b', 'b', './PiecesImg/B_Bishop.png')
wb = Piece('w', 'b', './PiecesImg/W_Bishop.png')
bq = Piece('b', 'q', './PiecesImg/B_Queen.png')
wq = Piece('w', 'q', './PiecesImg/W_Queen.png')
bkn = Piece('b', 'kn', './PiecesImg/B_Knight.png')
wkn = Piece('w', 'kn', './PiecesImg/W_Knight.png')
...
def king_moves(index):
    # if (index == (0, 4) or index == (7, 4)) and board[index[0]][index[1]].moved == 0:
    #     if board[index[0]][index[1]].team == 'w':
    #         if (board[7][0] != '  ' and board[7][0].type == 'r' and board[7][0].team == board[index[0]][index[1]].team and board[7][0].moved == 0):
    #             if board[index[0] - 2][index[1]] == '  ' and board[index[0] - 1][index[1]] == '  ':
    #                 board[index[0] - 2][index[1]] = 'x '
    #         if (board[7][7] != '  ' and board[7][7].type == 'r' and board[7][7].team == board[index[0]][index[1]].team and board[7][7].moved == 0):
    #             if board[index[0] + 2][index[1]] == '  ' and board[index[0] + 1][index[1]] == '  ':
    #                 board[index[0] + 2][index[1]] = 'x '
    #     if board[index[0]][index[1]].team == 'b':
    #         if (board[0][0] != '  ' and board[0][0].type == 'r' and board[0][0].team == board[index[0]][index[1]].team and board[0][0].moved == 0):
    #             if board[index[0] - 2][index[1]] == '  ' and board[index[0] - 1][index[1]] == '  ':
    #                 board[index[0] - 2][index[1]] = 'x '
    #         if (board[0][7] != '  ' and board[0][7].type == 'r' and board[0][7].team == board[index[0]][index[1]].team and board[0][7].moved == 0):
    #             if board[index[0] + 2][index[1]] == '  ' and board[index[0] + 1][index[1]] == '  ':
    #                 board[index[0] + 2][index[1]] = 'x '
    for y in range(3):
        for x in range(3):
